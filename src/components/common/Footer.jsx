...
const Footer = () => {
  ...
  return (
    <>
      <footer
        className={`${
          darkMode ? "dark bg-gray-900" : "light bg-gray-700"
      ...
      >
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <p className="text-slate-200 text-justify">
            ...
            Laboriosam, fugiat? Vero temporibus praesentium voluptatem commodi,
            vitae aliquam cum minus sunt?
          </p>
          <div
            id="social-icons"
          ...
          <h1 className="text-white mt-8">
            {" "}
            ©️ Copyright Real Estate, All Rights Reserved
          </h1>
        </div>
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-3">
            ...
            <p className="text-slate-200">Meadows Village, Las Vegas</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaMobile className="text-white size-5" />
            <p className="text-slate-200">+216 2902 0296</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaFax className="text-white size-5" />
            <p className="text-slate-200">+220 5646 5456</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <IoMdMail className="text-white size-5" />
            <p className="text-slate-200">support@tributaryre.com</p>
          </div>
        </div>
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">$ 287.90</p>
            </div>
          </div>
          <div className="flex justify-center items-center gap-4">
            <img
            ...
            <div>
              ...
              <p className="text-slate-400">$ 487.10</p>
            </div>
          </div>
        </div>
      </footer>
